...
* @{
*/
#define PRODUCT_KEY "0a4c8f2a19734392bf81c46ef054d074"
/**@} */
/**@name Product Secret (Product key)
* @{
*/
#define PRODUCT_SECRET "7b86ebc11ff4449389be17f726795055"
...
* @{
*/
#define On_Off_BYTEOFFSET                    0
#define On_Off_BITOFFSET                     0
#define On_Off_LEN                           1
#define Cold_Warm_BYTEOFFSET                    0
#define Cold_Warm_BITOFFSET                     1
#define Cold_Warm_LEN                           1

#define Temperature_RATIO                         1
#define Temperature_ADDITION                      16
#define Temperature_MIN                           0
#define Temperature_MAX                           14
/**@} */
...
typedef struct {
  uint8_t flagOn_Off:1;
  uint8_t flagCold_Warm:1;
